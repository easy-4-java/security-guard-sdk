...
安全防护（风控/反滥用）SDK 的项目骨架。在 `1.0.x.20260630-SNAPSHOT` 快照上，仓库中仅包含 Maven 工程骨架，尚未加入任何生产代码。
...
- 当前还不是可用的库：在 `1.0.x.20260630-SNAPSHOT` 快照上，项目**没有 `src/main/java` 源码**。
...
**预期结果：** 构建成功，并将一个（实际为空的）`security-guard-sdk-1.0.x.20260630-SNAPSHOT.jar` 安装到本地仓库。
