...
[![Java](https://img.shields.io/badge/Java-8-orange)](https://github.com/easy-4-java/security-guard-sdk) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)

Project scaffold for a security guard / anti-abuse SDK. As of the `1.0.x.20260630-SNAPSHOT` snapshot the repository contains the Maven project skeleton only — no production code has been added yet.
...
- It is not a usable library yet: the project contains **no `src/main/java` sources** at the `1.0.x.20260630-SNAPSHOT` snapshot.
...
```groovy
implementation 'io.github.easy4j:security-guard-sdk:1.0.x.20260630-SNAPSHOT'
```
...
**Expected result:** the build succeeds and installs an (effectively empty) `security-guard-sdk-1.0.x.20260630-SNAPSHOT.jar` into the local repository.
